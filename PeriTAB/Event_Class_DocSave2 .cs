...
namespace PeriTAB
{
    internal class Class_DocSave_Event2
    {
        ...
        {
            //if (Globals.ThisAddIn.Application.ActiveDocument.Saved) return;
        ...
        private void Testa_Se_Salvou(object sender, EventArgs e)
        {
            try
            {
                //if (Globals.ThisAddIn.Application.BackgroundSavingStatus > 0) return;
