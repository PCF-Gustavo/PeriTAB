...
namespace PeriTAB
{
    internal class Class_Controls
    {
        ...
        public void button_inteiro_valorinicial()
        {
            ...
            Globals.Ribbons.Ribbon1.button_inteiro.ScreenTip = "Macro inteiro_por_extenso";
        ...
        {
            Globals.Ribbons.Ribbon1.dropDown_separador.SelectedItem = GetDropDownItemFromLabel(Globals.Ribbons.Ribbon1.dropDown_separador, GetPreference("separador"));
        }
